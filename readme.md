...
RNF04: O sistema deve implementar controle de acesso baseado em funções (RBAC), garantindo que cada usuário tenha acesso somente às funcionalidades permitidas 
para seu cargo.
